      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-12">
          <div class="section-title">
            <h2 class="head-title lg-line">HONEST <br>Healthcare</h2>
            <hr class="botm-line">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <h3>Contact Info</h3>
          <div class="space"></div>
          <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>69 Daventry way ,  Komoka , <br>NOL1R0 ,ONTARIO321 </p>
          <div class="space"></div>
          <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>info@companyname.com</p>
          <div class="space"></div>
          <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>2265044465, 2265040465</p>
        </div>
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            ...
            <form action="" method="post" role="form" class="contactForm">
              ...
              <div class="form-group mb-4">
                <textarea class="form-control br-radius-zero" name="message" rows="30" data-rule="required" data-msg="Please write something for us" placeholder="Message"></textarea>
                <div class="validation"></div>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            © Copyright 
            <!-- <div class="credits">
              Designed by <a href="">BootstrapMade.com</a>
            </div> -->
          </div>
        </div>
      </div>
